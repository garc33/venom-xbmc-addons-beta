...
def showMovies(sSearch = ''):
    ...
    if 'series' in sUrl or 'documentaires' in sUrl or 'emissions' in sUrl or 'spectacles' in sUrl or 'animes-' in sUrl:
        ...
        sPattern = '<a title="" href="([^"]+?)[^>]+?><img class="[^"]+?" data-newsid="[^"]+?" src="([^<"]+)".+?<div class="cover_infos_global toh"><div class="cover_infos_title"><a title="" href="[^"]+?[^>]+?>([^<]+?) <span class="detail_release size_11">'
